                ...
                >
                    ...
                    >
                        ...
                        <p class="mt-3 text-sm text-muted">
                            Choose the transaction type to reveal only the
                            fields you need.
                        </p>
                            ...
                            <TabPanel>
                                <div class="grid gap-4 lg:grid-cols-2">
                                    ...
                                    >
                                        ...
                                        different from the source account.
                                    </div>
                                </div>
                            </TabPanel>
                        </TabPanels>
            ...
            <div class="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-end">
                ...
                <button
                    ...
                    :class="{
                        ...
                        'hover:bg-primary/90': transferAccountsValid,
                    }"
